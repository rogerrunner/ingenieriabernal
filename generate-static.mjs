...
const routes = [
  ...
  { path: 'servicios/estudio-inundabilidad-manizales', title: 'Estudio de Inundabilidad Manizales | BIC Bernal Ingeniería Consultores', desc: 'Estudio de inundabilidad en Manizales con modelación HEC-RAS 2D. Requerido por Corpocaldas, POT y POMCA Río Chinchiná. Manchas de inundación, amenaza hídrica Decreto 1807/2014. BIC — Manizales.', url: 'https://www.ingenieriabernal.co/servicios/estudio-inundabilidad-manizales' },
  ...
  { path: 'estudio-de-inundabilidad-pereira', title: 'Estudio de Inundabilidad en Pereira | BIC Ingeniería', desc: 'Estudios de inundabilidad en Pereira con HEC-RAS 2D. Requerido por CARDER, POT Pereira y licencias de construcción. +57 302 477 8910', url: 'https://www.ingenieriabernal.co/estudio-de-inundabilidad-pereira/' },
  { path: 'licencia-de-construccion-pereira', title: 'Licencia de Construcción Pereira: Documentos Técnicos | BIC', desc: 'BIC prepara estudios técnicos para licencia de construcción en Pereira: suelos, estructural, planos. Curadurías de Pereira. +57 302 477 8910', url: 'https://www.ingenieriabernal.co/licencia-de-construccion-pereira/' },
  { path: 'estudio-de-suelos-eje-cafetero', title: 'Estudio de Suelos Eje Cafetero | BIC Ingeniería', desc: 'Estudios de suelos en el Eje Cafetero: Manizales, Pereira y Armenia. Suelos volcánicos y cenizas del Quindío. NSR-10. +57 302 477 8910', url: 'https://www.ingenieriabernal.co/estudio-de-suelos-eje-cafetero/' },
  { path: 'consultoria-ingenieria-civil-manizales', title: 'Consultoría Ingeniería Civil Manizales | BIC', desc: 'Consultoría integral de ingeniería civil en Manizales: estudios técnicos, diseño, interventoría y gestión de proyectos. +57 302 477 8910', url: 'https://www.ingenieriabernal.co/consultoria-ingenieria-civil-manizales/' },
  { path: 'gestion-riesgo-hidrico-manizales', title: 'Gestión del Riesgo Hídrico Manizales | BIC Ingeniería', desc: 'Gestión del riesgo por inundaciones y avenidas torrenciales en Manizales y Caldas. Planes de contingencia y mitigación. +57 302 477 8910', url: 'https://www.ingenieriabernal.co/gestion-riesgo-hidrico-manizales/' },
  { path: 'diseno-hidraulico-eje-cafetero', title: 'Diseño Hidráulico Eje Cafetero | BIC Ingeniería', desc: 'Diseño hidráulico en Caldas, Risaralda y Quindío. Redes de acueducto, alcantarillado y estructuras. BIC cubre todo el Eje Cafetero. +57 302 477 8910', url: 'https://www.ingenieriabernal.co/diseno-hidraulico-eje-cafetero/' },
  { path: 'topografia-manizales', title: 'Topografía en Manizales | BIC Ingeniería', desc: 'Levantamientos topográficos en Manizales para diseño hidráulico, licencias de construcción y estudios de suelos. +57 302 477 8910', url: 'https://www.ingenieriabernal.co/topografia-manizales/' },

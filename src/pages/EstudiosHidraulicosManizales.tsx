...
const WA_MSG = encodeURIComponent('Hola, necesito estudios hidraulicos en Manizales y Caldas. Pueden cotizar?')

const seoConfig = {
  title: 'Estudios Hidraulicos Manizales y Caldas — HEC-RAS 2D Decreto 1807 | BIC COPNIA',
  description: 'BIC realiza modelacion hidraulica, estudios Decreto 1807, concesiones de aguas y permisos de vertimientos en Manizales y Caldas. CORPOCALDAS. COPNIA 17202-313228 CLD. Propuesta en 24 horas.',
  keywords: ['estudios hidraulicos Manizales Caldas', 'modelacion HEC-RAS Manizales Colombia', 'estudio Decreto 1807 Manizales Caldas', 'concesion aguas CORPOCALDAS Manizales', 'estudio riesgo hidrico Manizales urbanizacion'],
  canonical: 'https://ingenieriabernal.co/estudios-hidraulicos-manizales',
}
...
const SERVICIOS = [
  ...
  { t: 'Estudio Decreto 1807 — licencias', d: 'Estudio detallado de amenaza y riesgo hidrico exigido por la Curaduria de Manizales y Caldas para otorgar licencias de construccion y urbanismo en predios ubicados en zonas de amenaza hidrica media o alta. Cero observaciones en primera revision.' },
...
const FAQ = [
  { q: 'BIC realiza estudios hidraulicos en Manizales y Caldas?', a: 'Si. BIC atiende proyectos en Manizales y Caldas y todo el Caldas con visita tecnica presencial al predio. La sede tecnica esta en Manizales (Caldas), a menos de 3 horas de distancia. BIC tiene experiencia en tramites ante CORPOCALDAS con aprobaciones en primera revision.' },
  { q: 'Cuanto cuesta un estudio hidraulico en Manizales y Caldas?', a: 'El costo depende del tipo de estudio y alcance: un estudio Decreto 1807 para licencia de construccion parte de $8M COP; modelaciones HEC-RAS 2D para planes parciales o concesiones de agua cuestan entre $15M y $50M COP. BIC entrega propuesta tecnica y economica en 24 horas.' },
...
export default function EstudiosHidraulicosManizales() {
  useEffect(() => {
    window.scrollTo(0, 0)
    const s = document.createElement('script'); s.type = 'application/ld+json'; s.id = 'schema-manizales-faq'
    s.textContent = JSON.stringify(SCHEMA_FAQ); document.head.appendChild(s)
    const sb = document.createElement('script'); sb.type = 'application/ld+json'; sb.id = 'schema-manizales-bc'
    sb.textContent = JSON.stringify({
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Estudios Hidraulicos Manizales y Caldas', item: 'https://ingenieriabernal.co/estudios-hidraulicos-manizales' },
      ]
    }); document.head.appendChild(sb)
    return () => { document.getElementById('schema-manizales-faq')?.remove(); document.getElementById('schema-manizales-bc')?.remove() }
  }, [])
  return (
    <>
      <SEOHead config={seoConfig} />
      <CTABanner service="Estudios Hidraulicos Manizales y Caldas" />
      <section style={{ background: 'linear-gradient(135deg, #001A33 0%, #002A50 55%, #003B6F 100%)', paddingTop: 120, paddingBottom: 80, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 820, margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1 }}>
          <SectionLabel color="#60A5FA">Manizales · Caldas · CORPOCALDAS</SectionLabel>
          <h1 style={{ fontSize: 'clamp(26px, 5vw, 44px)', fontWeight: 800, color: '#fff', lineHeight: 1.15, marginBottom: 20 }}>
            Estudios Hidraulicos<br />en Manizales y Caldas
          </h1>
          <p style={{ fontSize: 17, color: '#CBD5E1', lineHeight: 1.75, marginBottom: 8, maxWidth: 700 }}>
            BIC realiza <strong style={{ color: '#fff' }}>modelacion HEC-RAS 2D</strong>, estudios <strong style={{ color: '#60A5FA' }}>Decreto 1807</strong>, tramites ante <strong style={{ color: '#60A5FA' }}>CORPOCALDAS</strong> y diseno de acueducto y alcantarillado en Manizales y Caldas y todo el Caldas.
          </p>
      ...
      <Section style={{ background: '#F8FAFC' }}>
        <SectionLabel>Servicios BIC en Manizales y Caldas</SectionLabel>
      ...
      <Section>
        ...
        <h2 style={{ fontSize: 'clamp(22px, 4vw, 32px)', fontWeight: 800, marginBottom: 32 }}>Estudios hidraulicos en Manizales y Caldas</h2>
      ...
      <ThinLine />
      <Section style={{ background: '#F8FAFC' }}>
        <h2 style={{ fontSize: 'clamp(22px, 4vw, 32px)', fontWeight: 800, textAlign: 'center', marginBottom: 12 }}>Solicite su propuesta para Manizales y Caldas</h2>

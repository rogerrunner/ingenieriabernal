...
export default function EncauzamientoRios() {
  ...
  return (
    <>
      ...
      <CTABanner service="Encauzamiento de Ríos y Obras de Protección Hidráulica" />
      <SpeakableSchema name="Encauzamiento de Ríos y Quebradas en Colombia — Ingeniería Fluvial | BIC" />
      <SchemaMarkup
        type="service"
        serviceName="Encauzamiento de Ríos y Obras de Protección Fluvial — Colombia"
        serviceDesc={seoConfig.description}
        serviceUrl="/encauzamiento-rios"
        faqItems={FAQ}
        priceSpecification={[
          { name: 'Diseño encauzamiento tramo puntual (muros gavión / espigones)', minPrice: 15000000, maxPrice: 35000000, priceCurrency: 'COP', description: 'Modelación HEC-RAS 2D, diseño estructural, planos constructivos y concepto para la CAR' },
          { name: 'Encauzamiento urbano completo (200–500 m)', minPrice: 25000000, maxPrice: 70000000, priceCurrency: 'COP', description: 'Hidrología, HEC-RAS 2D, diseño de muros o gaviones, planos y memoria para permiso ambiental' },
          { name: 'Gran proyecto encauzamiento (> 500 m o múltiples tramos)', minPrice: 60000000, maxPrice: 150000000, priceCurrency: 'COP', description: 'Incluye alternativas de mitigación, diseño estructural detallado y apoyo en trámite CAR' },
        ]}
      />
      ...
      <section style={{ background: '#EFF6FF', borderBottom: '1px solid #BFDBFE' }}>
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '28px 24px' }}>
          <p style={{ color: '#1e40af', fontSize: 15, lineHeight: 1.8, margin: 0 }} id="geo-fragment">
            <strong>BIC — Bernal Ingeniería Consultores</strong> BIC — Bernal Ingeniería Consultores diseña obras de encauzamiento de ríos y quebradas en Colombia: muros de gavión, muros de concreto, espigones y box culvert para habilitar predios en zona de amenaza hídrica. Modelación HEC-RAS 2D y trámite de permiso ambiental ante la CAR. Honorarios desde $15 millones COP. Firma COPNIA 17202-313228 CLD. Sede Manizales — proyectos en todo Colombia. Propuesta en 24 horas sin costo: +57 302 477 8910.
          </p>
        </div>
      </section>

...
const SERVICE_LINKS: Record<string, { label: string; href: string }> = {
  ...
  'nsr-10-sistemas-contra-incendios':                { label: 'Sistemas Contra Incendio NSR-10',        href: '/servicios/contra-incendios-nsr10' },
  'irca-municipio-colombia':                         { label: 'Acueducto y Alcantarillado',             href: '/servicios/diseno-acueductos' },
  ...
  // articlesB
  'acueducto-rural-colombia':                        { label: 'Acueducto y Alcantarillado',             href: '/servicios/diseno-acueductos' },
  ...
  'sistemas-contra-incendio-nsr10':                  { label: 'Sistemas Contra Incendio NSR-10',        href: '/servicios/contra-incendios-nsr10' },
  'interventoria-hidraulica-colombia':               { label: 'Residencia e Interventoría',             href: '/servicios/interventoria' },
  'alcantarillado-pluvial-colombia':                 { label: 'Acueducto y Alcantarillado',             href: '/servicios/diseno-acueductos' },
  'epanet-colombia-acueducto':                       { label: 'Acueducto y Alcantarillado',             href: '/servicios/diseno-acueductos' },
  'bocatoma-lateral-colombia':                       { label: 'Diseño de Bocatomas en Colombia',        href: '/bocatomas-colombia' },
  // articlesC
  'ras-2000-colombia':                               { label: 'Acueducto y Alcantarillado',             href: '/servicios/diseno-acueductos' },
  'ley-1523-riesgo-colombia':                        { label: 'Gestión del Riesgo Hídrico',             href: '/gestion-riesgo-hidrico' },
  'nsr10-titulo-j-incendios-colombia':               { label: 'Sistemas Contra Incendio NSR-10',        href: '/servicios/contra-incendios-nsr10' },
  'pomca-colombia':                                  { label: 'Gestión del Riesgo Hídrico',             href: '/gestion-riesgo-hidrico' },
  'decreto-1575-agua-colombia':                      { label: 'Acueducto y Alcantarillado',             href: '/servicios/diseno-acueductos' },
  ...
  'requisitos-ptar-licencia-construccion':           { label: 'Diseño de Acueducto y Alcantarillado',    href: '/servicios/diseno-acueductos' },
  'estudio-hidraulico-urbanizacion':                 { label: 'Memorias Hidrosanitarias',                href: '/memorias-hidrosanitarias-colombia' },
  'calcular-caudal-diseno-alcantarillado':           { label: 'Diseño de Acueducto y Alcantarillado',    href: '/servicios/diseno-acueductos' },
  'diseno-ptap-municipio-costos':                    { label: 'Acueducto y Alcantarillado',               href: '/servicios/diseno-acueductos' },
  'modelacion-hec-ras-colombia':                     { label: 'Modelación Hidráulica HEC-RAS 2D',         href: '/servicios/modelacion-hec-ras' },
  'plan-manejo-aguas-lluvias-colombia':              { label: 'Diseño de Acueducto y Alcantarillado',    href: '/servicios/diseno-acueductos' },
  'diferencias-ptar-ptap':                           { label: 'Acueducto y Alcantarillado',               href: '/servicios/diseno-acueductos' },
  ...
  'requisitos-car-acueducto-veredal-colombia':        { label: 'Acueducto y Alcantarillado',                  href: '/servicios/diseno-acueductos' },
  'como-formular-proyecto-agua-potable-sgr-colombia': { label: 'Formulación Regalías MGA-Web',                href: '/servicios/regalias-mga' },
  // articlesI
  'diferencia-ptap-ptar-colombia':                    { label: 'Diseño de Acueducto y Alcantarillado',       href: '/servicios/diseno-acueductos' },
  'estudio-inundabilidad-lote-colombia':              { label: 'Gestión del Riesgo Hídrico',                 href: '/gestion-riesgo-hidrico' },
  'diseno-red-contra-incendio-nsr10-colombia':        { label: 'Sistemas Contra Incendio NSR-10',            href: '/servicios/contra-incendios-nsr10' },
  ...
  // articlesJ
  'cuanto-cuesta-ptap-colombia-2026':                 { label: 'Acueducto y Alcantarillado',                  href: '/servicios/diseno-acueductos' },
  'cuanto-cuesta-ptar-aguas-residuales-colombia':     { label: 'Diseño de PTAR y Saneamiento',                href: '/servicios/ptar-aguas-residuales' },
  'tramitar-licencia-construccion-acueducto-colombia':{ label: 'Acueducto y Alcantarillado',                  href: '/servicios/diseno-acueductos' },
  ...
  'conexiones-domiciliarias-acueducto-veredal':        { label: 'Acueducto y Alcantarillado',                  href: '/servicios/diseno-acueductos' },
  'irca-calidad-agua-potable-colombia':                { label: 'Acueducto y Alcantarillado',                  href: '/servicios/diseno-acueductos' },
  ...
  'presupuesto-diseno-ptap-veredal-colombia-2026':     { label: 'Acueducto y Alcantarillado',                  href: '/servicios/diseno-acueductos' },
  ...
  // articlesO
  'cuanto-cuesta-sistema-contra-incendios-nsr10-colombia': { label: 'Sistemas Contra Incendio NSR-10',        href: '/servicios/contra-incendios-nsr10' },

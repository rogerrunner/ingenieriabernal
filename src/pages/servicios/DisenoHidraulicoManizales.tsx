...
const PROYECTOS = [
  { tipo: 'Alcaldías y empresas de servicios públicos', desc: 'Diseño de sistemas de acueducto, alcantarillado y PTAR para municipios y ESP del Eje Cafetero con financiación SGR. Memorias de cálculo, planos firmados y acompañamiento ante AMAC y curadurías.' },
  { tipo: 'Grandes promotores y constructoras en zona de expansión', desc: 'Diseño hidráulico para proyectos de más de 5 hectáreas en zonas de expansión de Manizales y el área metropolitana de Caldas: redes maestras, plantas de tratamiento y canales de drenaje.' },
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 24px', position: 'relative' }}>
          ...
          <p style={{
            ...
            BIC diseña sistemas hidráulicos para parques industriales, alcaldías, ESP y grandes promotores
            en Manizales y Caldas: redes de acueducto, alcantarillado, canales de drenaje y plantas de
            tratamiento. Entregamos memorias de cálculo, planos firmados y acompañamiento ante AMAC y
            las curadurías hasta aprobación. Registro COPNIA 17202-313228 CLD.
          </p>
        ...
        <div style={{ maxWidth: 680, margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: 32 }}>
            ...
            <p style={{ fontFamily: "'Lato', sans-serif", color: 'rgba(255,255,255,0.9)', fontSize: 15, lineHeight: 1.7, margin: 0 }}>
              ¿Tu empresa, alcaldía o proyecto requiere diseño hidráulico en Manizales o Caldas? Solicita tu propuesta técnica — revisamos el alcance sin costo.
            </p>
          </div>
          <Btn

...
export default function ServicioDisenoAcueductos() {
  ...
  return (
    <>
      ...
      <SchemaMarkup
        type="service"
        serviceName="Diseño de Acueductos en Colombia"
        serviceDesc={seoConfig.description}
        serviceUrl="/servicios/diseno-acueductos"
        faqItems={FAQ}
        priceSpecification={[
          { name: 'Diseño de acueducto', minPrice: 6000000, maxPrice: 25000000, description: 'Captación, conducción, red de distribución EPANET, RAS 2000, Resolución 0330/2017' },
          { name: 'Diseño PTAP', minPrice: 10000000, maxPrice: 40000000, description: 'Plantas de tratamiento de agua potable — coagulación, floculación, sedimentación, filtración' },
        ]}
      />
      ...
      {/* ── PRECIOS ── */}
      <section style={{ background: '#e8f7fc', padding: '52px 24px', borderTop: '1px solid #9ed9ea' }}>
        <div style={{ maxWidth: 880, margin: '0 auto', padding: '0 24px' }}>
          <SectionLabel>Inversión referencial</SectionLabel>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: 'clamp(22px, 3vw, 32px)', marginBottom: 8, color: '#001830' }}>
            ¿Cuánto cuesta el diseño de un acueducto en Colombia?
          </h2>
          <p style={{ color: '#555', lineHeight: 1.75, marginBottom: 28, maxWidth: 680 }}>
            Rangos referenciales para proyectos estándar. El precio depende del tamaño del sistema, el nivel de complejidad y si incluye el diseño de la PTAP.
          </p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 28 }}>
            <div style={{
              background: '#fff', border: '1px solid #9ed9ea', borderLeft: '4px solid #00B4D8',
              borderRadius: 10, padding: '18px 24px',
              display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12,
            }}>
              <div>
                <p style={{ fontWeight: 700, color: '#001830', fontSize: 15, margin: 0 }}>Diseño de acueducto</p>
                <p style={{ color: '#777', fontSize: 13, margin: '3px 0 0' }}>Captación, conducción, red de distribución EPANET, RAS 2000</p>
              </div>
              <div style={{ textAlign: 'right' }}>
                <p style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: 22, color: '#00B4D8', margin: 0 }}>$6M – $25M COP</p>
                <p style={{ color: '#888', fontSize: 12, margin: '2px 0 0' }}>según nivel de complejidad del sistema</p>
              </div>
            </div>
            <div style={{
              background: '#fff', border: '1px solid #9ed9ea', borderLeft: '4px solid #00B4D8',
              ...
              <div>
                <p style={{ fontWeight: 700, color: '#001830', fontSize: 15, margin: 0 }}>Diseño PTAP</p>
                <p style={{ color: '#777', fontSize: 13, margin: '3px 0 0' }}>Planta de tratamiento de agua potable — coagulación, floculación, filtración</p>
              </div>
              <div style={{ textAlign: 'right' }}>
                <p style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: 22, color: '#00B4D8', margin: 0 }}>$10M – $40M COP</p>
                <p style={{ color: '#888', fontSize: 12, margin: '2px 0 0' }}>según caudal y tren de tratamiento requerido</p>
              </div>
            </div>
          </div>
          <div style={{ background: '#d6f0f8', borderRadius: 8, padding: '14px 18px', marginBottom: 24, border: '1px solid #9ed9ea' }}>

  ...
  useEffect(() => {
    ...
    el.text = JSON.stringify({
      ...
      'itemListElement': [
        ...
        { '@type': 'ListItem', 'position': 3, 'name': 'Modelación HEC-RAS 2D', 'item': 'https://ingenieriabernal.co/servicios/modelacion-hec-ras' },
      ],
    })
      ...
      <Section bg="#EFF6FB" style={{ padding: '48px 24px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
            ...
            <a href="/servicios/modelacion-hidraulica-putumayo" style={{ flex: '1 1 220px', background: '#EEF6FB', border: '1px solid #17A2B8', borderRadius: 4, padding: '18px 20px', textDecoration: 'none' }}>
              <span style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, color: '#003B6F', fontSize: 14, display: 'block', lineHeight: 1.35 }}>¿Proyecto en Putumayo o Amazonia? Ver página especializada →</span>
              <span style={{ fontFamily: "'Lato', sans-serif", color: '#17A2B8', fontSize: 12, marginTop: 8, display: 'block' }}>Modelación HEC-RAS Putumayo →</span>
            </a>
          </div>
        </div>
      </Section>
      ...
      <Section bg="#17A2B8" style={{ padding: '64px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: 680, margin: '0 auto' }}>
          ...
          <p style={{
            ...
            Le respondemos con presupuesto y plazo de entrega en menos de 24 horas hábiles.
          </p>
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
            <Btn href={`https://wa.me/${WA}?text=${WA_MSG}`}>
              📱 Solicitar propuesta técnica
            </Btn>
            <Btn variant="outline" href="/contacto" dark>

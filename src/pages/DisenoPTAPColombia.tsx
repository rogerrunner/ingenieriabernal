...
const seoConfig = {
  title: 'Diseño PTAP — Plantas Tratamiento Agua Potable · BIC',
  description: 'Diseño de PTAP para comunidades rurales y municipios pequeños. Norma RAS 2017. Proyectos en Caldas desde 2010. Presupuesto sin costo.',
  keywords: [

...
const LOCAL_BUSINESS_SCHEMA = {
  ...
  alternateName: 'Bernal Ingeniería Consultores',
  url: BASE_URL,
  logo: BASE_URL + '/logo.png',
  image: BASE_URL + '/og-default.jpg',
  description: 'Firma de consultoría en ingeniería hidráulica, hidrosanitaria, ambiental y gestión del riesgo con presencia en Colombia, Ecuador y México. Más de 10 años de experiencia. Egresados UNAL Manizales — COPNIA 17202-313228.',
  ...
  address: {
    '@type': 'PostalAddress',
    streetAddress: 'Calle 65A #23B-24, Guayacanes',
  ...
  hasOfferCatalog: {
    '@type': 'OfferCatalog',
    name: 'Servicios de Ingeniería BIC',
    itemListElement: [
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Diseño hidrosanitario y contra incendios NSR-10' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Modelación HEC-RAS e inundaciones' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Acueducto y alcantarillado Resolución 0330' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Gestión del riesgo hídrico y POT' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'PTAP y PTAR — plantas de tratamiento' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Formulación proyectos regalías MGA-Web SGR' } },

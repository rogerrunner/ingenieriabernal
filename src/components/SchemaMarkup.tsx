...
const LOCAL_BUSINESS_SCHEMA = {
  ...
  knowsAbout: [
    ...
    'Modelación hidráulica HEC-RAS 2D',
    'Diseño hidrosanitario NSR-10 Títulos J y K',
    'Sistema contra incendio NSR-10 Capítulo J',
    'Diseño de acueductos rurales RAS 2017',
    'Plantas de tratamiento de agua potable PTAP',
    'Plantas de tratamiento de aguas residuales PTAR',
    'Concesiones de aguas CAR Colombia',
    'Estudios hidrológicos Colombia',
    'Formulación proyectos SGR MGA-Web',
    'Decreto 1076 de 2015 trámites ambientales',
    'Plan parcial componente riesgo inundación',
  ],
  hasOfferCatalog: {
    '@type': 'OfferCatalog',

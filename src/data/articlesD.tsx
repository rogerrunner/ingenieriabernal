...
const articlesD: Record<string, {
  ...
  'decreto-1807-riesgo-inundacion-colombia': {
    title: 'Decreto 1807 de 2014 Colombia: Estudios Requeridos para POT y Licencias | BIC',
    date: 'Mayo 2026',
    readTime: '14 min',
    category: 'Riesgo Hidrico',
    metaDesc: 'Decreto 1807 de 2014: que estudios exige para POT, licencias de construccion y planes parciales en Colombia. Metodologia, costos reales y quien los firma. COPNIA.',
